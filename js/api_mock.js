...
(function() {
    ...
    const DEFAULT_QUIZZES = [
        ...
        },
        {
            id: 102,
            course_name: "مسار القرآن الكريم والتدبر",
            title: "التفسير وتدبر القرآن - الأسبوع الأول: أسرار وفضائل سورة الفاتحة",
            description: JSON.stringify({
                track: "tafsir",
                week_number: 1,
    ...
    const DEFAULT_QUIZ_QUESTIONS = [
        ...
        {
            id: 104, quiz_id: 102,
            question_text: "لماذا سُميت سورة الفاتحة بـ 'أم الكتاب'؟",
            points: 5,
            options: ["لأنها أطول سورة في القرآن", "لأنها اشتملت على مجمل مقاصد القرآن الكريم من توحيد وعبادة وهداية", "لأنها نزلت في المدينة المنورة", "لأنها تحتوي على أحكام الميراث"],
            correct_option_index: 1
        },
        {
            id: 105, quiz_id: 102,
            question_text: "ما معنى 'الصِّرَاطَ الْمُسْتَقِيمَ' في سورة الفاتحة؟",
            points: 5,
            options: ["طريق التجارة", "دين الإسلام الحق والتمسك بكتاب الله وسنة نبيه", "الحياة الدنيا وزينتها", "النسب والقبيلة"],
            correct_option_index: 1
        },
        {
            id: 106, quiz_id: 102,
            question_text: "ما الركن الأساسي الذي تضمنته آية (إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ)؟",
            points: 5,
            options: ["التجارة والشراكة", "إخلاص العبادة والاستعانة بالله وحده لا شريك له", "طلب العلم الدنيوي فقط", "الاعتماد على الأسباب دون التوكل"],
            correct_option_index: 1
        },
        {
            id: 107, quiz_id: 103,
