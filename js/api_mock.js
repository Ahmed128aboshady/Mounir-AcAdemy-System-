...
(function() {
    ...
    const DEFAULT_QUIZZES = [
        ...
        },
        {
            id: 103,
            course_name: "مسار القرآن الكريم والتدبر",
            title: "الحديث الشريف والسنة النبوية - الأسبوع الأول: حديث إنما الأعمال بالنيات",
            description: JSON.stringify({
                track: "hadith",
                week_number: 1,
    ...
    const DEFAULT_QUIZ_QUESTIONS = [
        {
            id: 101, quiz_id: 101,
            question_text: "كم عدد حروف الإظهار الحلقي في أحكام النون الساكنة والتنوين؟",
            points: 5,
            options: ["4 حروف", "6 حروف", "8 حروف", "15 حرفاً"],
            correct_option_index: 1
        },
        {
            id: 102, quiz_id: 101,
            question_text: "أي من الحروف التالية يُعد من حروف الإظهار الحلقي؟",
            points: 5,
            options: ["اليرملون", "الهمزة والعين والحاء", "الباء فقط", "القاف والكاف"],
            correct_option_index: 1
        },
        {
            id: 103, quiz_id: 101,
            question_text: "ما الحكم التجويدي في قوله تعالى: (مَنْ آمَنَ)؟",
            points: 5,
        ...
        {
            id: 201, quiz_id: 102,
            question_text: "ماذا يعني أن القرآن «حكيم» في سياق الحلقة؟",
            points: 3,
            options: [
                "يحتوي على أكبر عدد ممكن من المعلومات",
                "جاء بالحق والحكمة، وما فيه من أخبار وأوامر ونواهٍ وأحكام قائم على الحكمة",
                "يجيب عن كل سؤال دنيوي بتفصيله",
                "لا يحتاج الإنسان إلى فهمه"
            ],
            correct_option_index: 1
        },
        {
            id: 202, quiz_id: 102,
            question_text: "أي عبارة تعبّر بشكل أفضل عن معنى: (وَهُم بِالْآخِرَةِ هُمْ يُوقِنُونَ)؟",
            points: 3,
            options: [
                "لا يهتمون بالحياة الدنيا",
                "يؤمنون بالآخرة ويقينهم بها يؤثر في نظرتهم لأعمالهم واختياراتهم",
                "يعرفون موعد يوم القيامة",
                "لا يمكن أن يخطئوا"
            ],
            correct_option_index: 1
        },
        {
            id: 203, quiz_id: 102,
            question_text: "ماذا نفهم من قوله تعالى: (أُوْلَٰئِكَ عَلَىٰ هُدًى مِّن رَّبِّهِمْ)؟",
            points: 3,
            options: [
                "الهداية معلومة نحفظها فقط",
                "الهداية طريق يسير عليه الإنسان، وهي من الله",
                "كل شخص يصنع لنفسه طريق الهداية",
                "الهداية تعني عدم الوقوع في أي خطأ"
            ],
            correct_option_index: 1
        },
        {
            id: 204, quiz_id: 102,
            question_text: "شخص يعرف أن الصلاة مهمة، لكنه يؤجلها دائمًا بسبب الألعاب. أي فكرة من الحلقة تساعده أكثر؟",
            points: 3,
            options: [
                "المعرفة وحدها تكفي.",
                "المشكلة أنه لا يحب الصلاة.",
                "أحتاج أن أتدرّب على اختيار ما أعرف أنه حق، وأنظم وقتي مسبقًا.",
                "الأفضل أن أتوقف عن اللعب نهائيًا"
            ],
            correct_option_index: 2
        },
        {
            id: 205, quiz_id: 102,
            question_text: "أي عبارة تعبّر عن الفكرة الصحيحة حول الترفيه؟",
            points: 3,
            options: [
                "كل الترفيه حرام أو ضار",
                "يجب أن نبتعد عن الألعاب والموبايل تمامًا",
                "الترفيه ليس المشكلة، لكن المشكلة عندما يبدأ بالتحكم في وقتي وأولوياتي واختياراتي",
        ...
        {
            id: 107, quiz_id: 103,
            question_text: "من هو الصحابي الجليل راوي حديث (إنما الأعمال بالنيات)؟",
            points: 5,
            options: ["أبو هريرة رضي الله عنه", "عمر بن الخطاب رضي الله عنه", "عبد الله بن عباس رضي الله عنه", "أنس بن مالك رضي الله عنه"],
            correct_option_index: 1
        },
        {
            id: 108, quiz_id: 103,
            question_text: "ما هو الشرط الأساسي لقبول أي عمل صالح عند الله تعالى؟",
            points: 5,
            options: ["كثرة المصلين حوله", "الإخلاص لله وموافقة هدي النبي صلى الله عليه وسلم", "الشهرة والرياء بين الناس", "المكان الذي يؤدى فيه العمل فقط"],
            correct_option_index: 1
        },
        {
            id: 109, quiz_id: 103,
            question_text: "ما الثمرة الكبرى للنية الصالحة في حياة المسلم؟",
            points: 5,
            options: ["تحويل العادات اليومية المباحة إلى عبادات يؤجر عليها العبد", "الفوز بالثناء من الناس", "التفاخر بالأعمال الصالحة", "عدم الحاجة لأداء العمل"],
            correct_option_index: 0
        }
    ];

    let DB = DEFAULT_DB;
    if (!DB.quizzes) DB.quizzes = DEFAULT_QUIZZES;
    if (!DB.quiz_questions) DB.quiz_questions = DEFAULT_QUIZ_QUESTIONS;
    if (!DB.quiz_submissions) DB.quiz_submissions = [];
    ...
    async function handleMock(url, options = {}) {
        ...
        if (path === '/api/auth/login' && method === 'POST') {
            ...
            if (user.role === 'admin') {
                if (!pInput || user.password_hash !== pInput) {
                    return jsonResponse({ detail: "اسم المستخدم أو كلمة المرور غير صحيحة" }, 401);
                }
            } else if (pInput && user.password_hash !== pInput && pInput !== '123456') {
        ...
        // 9. Quizzes & Weekly Assessments API
        if (path === '/api/quizzes' && method === 'GET') {
            const quizzes = (DB.quizzes && DB.quizzes.length) ? DB.quizzes : DEFAULT_QUIZZES;
            return jsonResponse(quizzes);
        }

        const quizDetailMatch = path.match(/\/api\/quizzes\/(\d+)$/);
        if (quizDetailMatch && method === 'GET') {
            const qId = parseInt(quizDetailMatch[1]);
            const quizzes = (DB.quizzes && DB.quizzes.length) ? DB.quizzes : DEFAULT_QUIZZES;
            const questions = (DB.quiz_questions && DB.quiz_questions.length) ? DB.quiz_questions : DEFAULT_QUIZ_QUESTIONS;
            const quiz = quizzes.find(q => q.id === qId) || quizzes[0];
            const qList = questions.filter(q => q.quiz_id === qId);
            return jsonResponse({ quiz, questions: qList });
        }

        const quizSubmitMatch = path.match(/\/api\/quizzes\/(\d+)\/submit$/);
        if (quizSubmitMatch && method === 'POST') {
            const qId = parseInt(quizSubmitMatch[1]);
            const questions = (DB.quiz_questions && DB.quiz_questions.length) ? DB.quiz_questions : DEFAULT_QUIZ_QUESTIONS;
            const qList = questions.filter(q => q.quiz_id === qId);
            ...
            qList.forEach(q => {
                ...
                totalPoints += pts;
                if (userAnswers[q.id] !== undefined && parseInt(userAnswers[q.id]) === q.correct_option_index) {
                    earnedPoints += pts;
                }
            });
            ...
            if (!DB.quiz_submissions) DB.quiz_submissions = [];
            const subRecord = {
                id: DB.quiz_submissions.length + 1,
                quiz_id: qId,
                student_id: body.student_id || 1,
                student_code: body.student_code || 'st0419',
                student_name: body.student_name || 'طالب الأكاديمية',
                track_name: body.track_name || 'أحكام التجويد',
                quiz_title: body.quiz_title || 'اختبار الأسبوع',
                score: earnedPoints,
            ...
            DB.quiz_submissions.unshift(subRecord);
            saveDb();
            return jsonResponse({ success: true, submission: subRecord });
        }

        if (path === '/api/admin/quizzes/submissions' && method === 'GET') {
            return jsonResponse(DB.quiz_submissions || []);
        }

        if (path === '/api/admin/quizzes/create' && method === 'POST') {
            if (!DB.quizzes) DB.quizzes = [...DEFAULT_QUIZZES];
            if (!DB.quiz_questions) DB.quiz_questions = [...DEFAULT_QUIZ_QUESTIONS];

            const newQId = 100 + DB.quizzes.length + 1;
            const newQuiz = {
                id: newQId,
                course_name: body.course_name || "مسار القرآن الكريم والتدبر",
                title: body.title,
                description: typeof body.description === 'string' ? body.description : JSON.stringify(body.description || {}),
                total_questions: body.questions ? body.questions.length : 3,
            ...
            if (body.questions && Array.isArray(body.questions)) {
                body.questions.forEach((q, idx) => {
                    DB.quiz_questions.push({
                        id: 200 + DB.quiz_questions.length + 1,
                        quiz_id: newQId,
            ...
            saveDb();
            return jsonResponse({ success: true, quiz: newQuiz });
        }

        if (path.startsWith('/api/student/') && path.endsWith('/quizzes')) {
            const parts = path.split('/');
            const stId = parts[3];
            const subs = (DB.quiz_submissions || []).filter(s => 
                String(s.student_id) === String(stId) || 
                String(s.student_code || '').toLowerCase() === String(stId).toLowerCase()
            );
